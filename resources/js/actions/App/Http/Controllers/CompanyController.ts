 ...
 * @see app/Http/Controllers/CompanyController.php:14
 * @route '/companies'
 */
 ...
 * @see app/Http/Controllers/CompanyController.php:23
 ...
 * @see app/Http/Controllers/CompanyController.php:35
 ...
 * @see app/Http/Controllers/CompanyController.php:49
 * @route '/companies/{company}'
 */
...
const CompanyController = { index, create, store, show, edit, update, destroy }
